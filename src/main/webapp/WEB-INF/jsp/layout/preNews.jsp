								...
								<div class="row">
									<div class="col-md-7 col-lg-6 ">
										<div class="detail-box">
											...
											<p>${news.shortIndex}</p>
											<div class="btn-box">
												<a href="${contextRoot}/News/ViewNewsPage?id=${news.newsNumber}"
													class="btn1"> 點我看更多 </a>
											</div>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-7 col-lg-6 ">
										<div class="detail-box">
											...
											<div class="btn-box">
												<a href="${contextRoot}/News/ViewNewsPage?id=${news2.newsNumber}"
													class="btn1"> 點我看更多 </a>
											</div>
										</div>
									</div>
									<div class="col-sm-7 col-xl-6">
										<div class="slp">
											<img src="${news2.picFile}" width="500px" class="d-block w-100" alt="...">
										</div>
									</div>
								</div>
							</div>
								...
								<div class="row">
									<div class="col-md-7 col-lg-6 ">
										<div class="detail-box">
											...
											<div class="btn-box">
												<a href="${contextRoot}/News/ViewNewsPage?id=${news3.newsNumber}"
													class="btn1"> 點我看更多 </a>
											</div>
										</div>
									</div>
									<div class="col-sm-7 col-xl-6">
										<div class="slp">
											<img src="${news3.picFile}" width="500px" class="d-block w-100" alt="...">
										</div>
									</div>
								</div>
							</div>
