...
/* 						 	height: 4vh;  */
				...
				<body>
								...
								<div class="card-body">
									...
									<form:form action="${contextRoot}/News/ViewNewsPage" method="post"
										...
										<div class="input-group">
											...
											<form:input type="hidden" value="${News.newsNumber}" path="newsNumber"
												class="form-control" />
										</div>
							...
							<table class="tablePost">
								<tr>
									<td class="userImg" rowspan="2"><img class="userIcon"
											src="${contextRoot}/images/forumImages/user_baseball.jpg">
									</td>
									<td class="userName" colspan="2">
										<div class="userName">${workMessage.userId}</div>
									</td>
									<td class="edit" rowspan="2"><a href="">修改</a> ｜ <a onclick="return confirm('確定刪除?')" href='${contextRoot}/delMessage?delid=${workMessage.postNumber}'>刪除</a>
									</td>
								...
								<!-- 							<tr> -->
								<!-- 								<td class="forumTitle" colspan="4">arr</td> -->
								<!-- 							</tr> -->
								<tr>
					...
					<a onclick="return confirm('確定刪除?')" href='${contextRoot}/delNews?delid=${News.newsNumber}'>del</a>
