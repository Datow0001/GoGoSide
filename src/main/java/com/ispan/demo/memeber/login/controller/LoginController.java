...
public class LoginController {
	...
	public String doLogin(@Valid @ModelAttribute("login") Login login, BindingResult bindingResult, Model model,
...
//			String nextPath=(String)session.getAttribute("servletPath");
	...
	@PostMapping("/forget")
	public String findbyId(Member member, Model model) {
		Member memberA = mService.findByUserId(member.getUserId());
		Member memberB = mService.findByPersonId(member.getPersonId());
	...
	@PostMapping("/reset")
//	public String reset(@Valid @RequestParam(name="word")String pass,BindingResult result ,Member member) {
	public String resrt(@Valid Member member, BindingResult result) {
